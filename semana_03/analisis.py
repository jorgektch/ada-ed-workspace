...
def ejecutar_analisis9():
    ...
    st.latex(r'''
        \begin{cases}
        T(a,b) = c_{1} & \text{Si } b = 0 \\
        T(a,b) = c_{2} & \text{Si } b = 1 \\
        T(a,b) = c_{3} + T(2a, \frac{b}{2}) & \text{Si } b \text{ es par y } b > 1 \\
        T(a,b) = c_{4} + T(2a, \frac{b}{2}) & \text{Si } b \text{ es impar y } b > 1
        \end{cases}
    ''')

    st.write("Paso 4: Derivar definición no recursiva de T(a,b)")
    st.write("Caso: b es una potencia de 2, \( b = 2^m \)")
    st.latex(r'''
        \begin{align*}
...
def ejecutar_analisis10():
    ...
    st.latex(r'''
        \begin{cases}
        T(n,x) = c_{1} & \text{Si } x \leq 1 \\
        T(n,x) = c_{2} + T(n, x-1) & \text{Si } x > 1
        \end{cases}
    ''')
...
def ejecutar_analisis11():
    ...
    st.latex(r'''
        \begin{cases}
        T(n) = c_{1} & \text{Si } n \text{ es factor de } a \text{ y } b \\
        T(n) = c_{2} + T(n-1) & \text{Si } n \geq 1
        \end{cases}
    ''')
